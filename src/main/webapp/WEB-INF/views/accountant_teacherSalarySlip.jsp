...
<div class="card mb-3">
		<div class="card-header">
			<i class="fas fa-table"></i> Language Institute-teacher Salary Slip
		</div>
		<div class="card-body">
			<div class="table-responsive">
				...
				<a href="accountant/payTeacher?id=${teacher.getId()}&amount=${netSalary}" class="btn btn-success" role="button">Pay Salary</a>
			</div>
		</div>
