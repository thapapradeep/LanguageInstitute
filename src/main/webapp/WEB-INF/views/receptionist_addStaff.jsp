         	...
         	<div class="col-lg-12">
         		<div class="panel panel-default">
         			...
         			<div class="panel-heading">
         				Language Institute-Add Staff Form
         			</div>
         			<hr/>
         			...
         			<div class="panel-body">
         				<div class="row">
         					...
         					<div class="col-lg-offset-3 col-lg-6">
         						<form:form action="receptionist/add-addStaff" method="POST" modelAttribute="staff">
         							...
         							<div class="form-group">
         								...
         								<form:input path="contact" class="form-control" placeholder="Enter contactnumber"/>
         								<form:errors path="contact" cssClass="error"/>
         							</div>
         								<div class="form-group">
         								<label>Select Role</label>
         								<form:select path="role" items="${roleList}" itemLabel="role" itemValue="id"  class="form-control" placeholder="Select Role"/>
         							</div>
